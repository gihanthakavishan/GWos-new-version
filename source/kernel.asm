...
[SEGMENT .data]
    strWelcomeMsg   db  "Hello Welcome to GWos version 1.0.0 - Enter help to display commands", 0x00
	strPrompt		db	"GWos>>", 0x00
	cmdMaxLen		db	255			;maximum length of commands

	strOsName		db	"TLUX", 0x00	;OS details
	strMajorVer		db	"1", 0x00
	strMinorVer		db	".0.0", 0x00

	cmdVer			db	"version", 0x00		; internal commands
	cmdExit		db	"reboot", 0x00
	cmdHelp		db	"help", 0x00
	cmdInfo		db	"show",0x00
	
	
	strHelpMsg1		db  "Type version to display the new version",0x00
	strHelpMsg2		db  "Type show for displaying Hardware informations of the machine",0x00
	strHelpMsg3		db  "Type reboot to rebooting the system",0x00
	...
	msgUnknownCmd		db	"Invalid command or incorrect filename!", 0x00
